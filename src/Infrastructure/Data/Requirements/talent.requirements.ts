...
export default class TalentRequirements {
    // [talent level => {stuff needed to next talent}]
    public static readonly TALENT_REQUIRED_AMOUNTS: Record<number, TalentAmount> = {
    ...
    public static readonly TALENT_REQUIRED_QUALITIES: Record<number, TalentQuality> = {
