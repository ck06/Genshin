...
VALUES ('Alley Hunter', 'Bow', 4, 'Gacha'),
       ...
       ('Blackcliff Amulet', 'Catalyst', 4, 'Starglitter Exchange'),
       ...
       ('Prototype Malice', 'Catalyst', 4, 'Crafting'),
       ...
       ('Prototype Aminus', 'Claymore', 4, 'Crafting'),
       ...
       ('Prototype Grudge', 'Polearm', 4, 'Crafting'),
